use crate::crypto_publisher::coin_struct;
use coin_struct::{CoinbasePrice, CoinbaseTime};
use reqwest::Client;
...
#[tokio::main]
pub async fn get_coin_time() -> Result<std::string::String, Box<dyn std::error::Error>> {
